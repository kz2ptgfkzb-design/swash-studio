...
export function Testimonials() {
  return (
    <section className="relative bg-paper-200/30 py-16 sm:py-24 md:py-40">
      <div className="container-page">
        <Reveal>
          <span className="eyebrow">In their words</span>
        </Reveal>
        <Reveal delay={1}>
          <h2 className="mt-4 max-w-[18ch] font-display text-display-lg text-balance text-ink-700 sm:mt-6">
        ...
        <ul className="mt-8 grid grid-cols-1 gap-4 sm:mt-14 sm:gap-6 md:grid-cols-3">
          {QUOTES.map((q, i) => (
            <Reveal key={q.name} delay={i}>
              <li className="flex h-full flex-col justify-between gap-6 rounded-card border border-hairline bg-paper-200/60 p-6 sm:gap-8 sm:p-8 md:p-10">
                ...
                <p className="text-pretty font-display text-lg leading-snug tracking-tight text-ink-700 sm:text-xl md:text-2xl">
                  {q.body}
                </p>
